...
const page = () => {
    ...
    const basicValidationChecks = () => {
        ...
        // Now we have to validate email using regex
    ...
    const handleLogin = async (e) => {
        ...
        e.preventDefault()
        setError("") // reset privious errors
    ...
    return (
        ...
        <div className=' container mx-auto px-6 pt-10 pb-10 text-white flex flex-col items-center text-center justify-center'>
            ...
            <div className="w-full max-w-md bg-slate-900/70 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
                ...
                <h1 className="text-white text-2xl md:text-4xl font-bold mb-4 md:mb-8">
                    Welcome back
                </h1>
                ...
                <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 mb-5 text-white placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-purple-500"
                />
                ...
                {/* DON'T CHANGE YOUR BUTTON COMPONENT */}
                {error && (
                    <>
                ...
                {/* Divider */}
                <div className="my-2 md:my-6 flex items-center">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3  py-2 md:py-3 rounded-lg  transition mb-2 hover:cursor-pointer border-white/10 bg-white/5 hover:bg-white/10"
                >
                    <img
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-2 md:py-3 rounded-lg transition hover:cursor-pointer border-white/10 bg-white/5 hover:bg-white/10"
                >
                    <img
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                    ...
                    <span onClick={() => setsignUp(!signUp)} className="text-blue-500 cursor-pointer hover:underline">
